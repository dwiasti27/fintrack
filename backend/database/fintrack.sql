-- FINTRACK Database Script
-- Jalankan file ini di phpMyAdmin (tab Import) atau MySQL CLI
...
CREATE TABLE IF NOT EXISTS categories (
    id INT AUTO_INCREMENT PRIMARY KEY,
    user_id INT NULL COMMENT 'NULL = kategori default global, ada nilai = kategori custom milik user',
